...
const Cards = ({
    ...
    const mediainfoTitle = searching ?
        <h6 className="currentyLoadedMedia">Searched for '{searchText}' - {totalResults} results found</h6> : null;

    // Display the media type being displayed
    const filteredText = !searching ? mediaType === 'movie' ?
        <h6 className="currentyLoadedMedia uppercase">{displayTitle + 's'}</h6> :
        <h6 className="currentyLoadedMedia uppercase">{displayTitle} series</h6> : null;
    ...
    return (
        <section className="card-container-grid">
            ...
            <GridCards fechedResults={searchResult}/>
