  ...
  return (
    <div className='media-side-nav'>
      ...
      <div className='categories-wrap grey-text lighten-3'>
        ...
        <p onClick={() => fetchData(mediaType, 'airing_today')}><NavLink to='/tv/airing_today' activeClassName='activeNav'>Airing Today</NavLink></p>
        <p onClick={() => fetchData(mediaType, 'popular')}><NavLink to='/tv/popular' activeClassName='activeNav'>Popular</NavLink></p>
        <p onClick={() => fetchData(mediaType, 'top_rated')}><NavLink to='/tv/top_rated' activeClassName='activeNav'>Top Rated</NavLink></p>
        <p onClick={() => fetchData(mediaType, 'on_the_air')}><NavLink to='/tv/on_the_air' activeClassName='activeNav'>On The Air</NavLink></p>
      </div>
    </div>
  )
}
